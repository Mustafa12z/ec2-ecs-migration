...
log "Deploying static frontend..."
FRONTEND_DIR="/var/www/flask-frontend"
mkdir -p "$FRONTEND_DIR"
if [ -d "$APP_DIR/frontend" ]; then
    cp -r "$APP_DIR/frontend/." "$FRONTEND_DIR/"
    chown -R www-data:www-data "$FRONTEND_DIR"
else
    log "WARNING: frontend directory not found, skipping frontend deploy"
fi
