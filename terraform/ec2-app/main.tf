...
# Data source for latest Ubuntu 22.04 LTS (Jammy) AMI
# The provisioning scripts are Debian/Ubuntu-based (apt-get, ubuntu user,
# nginx sites-available, www-data), so the AMI must be Ubuntu to match.
data "aws_ami" "ubuntu" {
  most_recent = true
